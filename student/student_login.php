    ...
    *{
    ...
    <body style="background-color: silver">
        ...
        <main style="font-size: 30px">
            <h3 style="padding-top: 100px">Student Login Form</h3>
        ...
        {
            $count=0;
        $req=mysqli_query($link,"select * from registration where Username='$_POST[username]' && Password='$_POST[password]' && status='Yes'");
